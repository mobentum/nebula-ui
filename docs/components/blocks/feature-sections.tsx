...
const features = [
  { title: 'Real-time analytics', desc: 'Stream metrics as they happen with sub-second latency.', icon: 'M3 17l6-6 4 4 8-8' },
  { title: 'Global edge network', desc: 'Deploy to 30+ regions with automatic failover.', icon: 'M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8z' },
  { title: 'Enterprise security', desc: 'SOC 2, SSO, and encryption at rest by default.', icon: 'M12 3l7 4v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V7z' },
  { title: 'Team collaboration', desc: 'Shared dashboards, comments, and role-based access.', icon: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z' },
  { title: 'Unlimited integrations', desc: 'Connect 100+ tools with prebuilt connectors.', icon: 'M8 12h8M12 8v8M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2z' },
  { title: 'Reliable uptime', desc: '99.99% SLA with proactive monitoring.', icon: 'M12 6v6l4 2M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2z' },
];
        ...
        {splitFeatures.map((f, i) => (
          ...
          >
            <div className="flex-1">
              <p className="text-xs font-medium uppercase tracking-wider text-nb-primary">{f.eyebrow}</p>
            ...
            <div className="flex h-48 w-full max-w-sm items-center justify-center rounded-xl border border-nb-border bg-nb-muted/40 md:h-40 md:w-1/2">
              <svg className="h-10 w-10 text-nb-muted-fg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden>
                <path d={f.icon} strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
